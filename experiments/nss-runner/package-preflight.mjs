...
const expected={
  ...
  evaluation:'2d3ce52920c98dc1a74103dac2b2773d598fc8ef5e83384302e1c2b07ef7ec81',
  manifest:'bb54d81ae13ce5e1e20896fe1abac6ee736dee16e28203a5f1d25863ea0d0c1c',
...
const evaluation=readFileSync(new URL('./nss1-r1-evaluation-contract.json',import.meta.url),'utf8');
...
const observed={routing:sha(routing),adapter:sha(adapter),evaluation:sha(evaluation),manifest:sha(manifest)};
const gates={
  routing_hash:observed.routing===expected.routing,
  adapter_hash:observed.adapter===expected.adapter,
  evaluation_hash:observed.evaluation===expected.evaluation,
  ...
  evaluation_binding:m.evaluation_contract_sha256===expected.evaluation,
