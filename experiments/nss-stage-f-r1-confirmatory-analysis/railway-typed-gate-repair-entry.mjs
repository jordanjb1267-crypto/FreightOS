// Railway entry for the Stage-F R1 Phase-V typed-gate comparator repair.
// Network is permitted only while materializing the exact frozen Stage-F gold archive.
// The successor verifier itself performs zero provider calls and hard-disables fetch.
