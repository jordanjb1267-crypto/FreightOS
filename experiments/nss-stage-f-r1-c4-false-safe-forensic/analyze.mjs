...
function flattenScalars(value,prefix='event',out={}){
  ...
  if(Array.isArray(value)){
    // Preserve short primitive arrays as one stable categorical feature; ignore nested arrays.
...
function featureTokens(record){
  ...
  for(const [k,v] of Object.entries(record.scalar_event_features ?? {})){
    const s=String(v);
    // High-cardinality identity/cryptographic surfaces are evidence, not useful rule candidates.
