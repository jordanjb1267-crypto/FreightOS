...
if (await exists(ROOT)) throw new Error('TYPED_GATE_REPAIR_OUTPUT_ALREADY_EXISTS_FAIL_CLOSED');
await mkdir(ROOT, { recursive: false });

process.env.STAGE_F_R1_ANALYSIS_PHASE_V_OUT = PREDECESSOR_OUT;
process.exitCode = 0;
await import('../nss-stage-f-r1-confirmatory-analysis/verify-analysis.mjs');
...
const typedAuthorityMatch = typeof predecessor.gates.authority_effects.observed === 'string' && predecessor.gates.authority_effects.observed === 'NONE' && predecessor.authority_effects === 'NONE';
