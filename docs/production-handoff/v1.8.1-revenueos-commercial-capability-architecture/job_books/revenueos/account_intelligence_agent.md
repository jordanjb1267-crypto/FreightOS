# Account Intelligence Agent — Provisional Audit-Candidate Job Book
...
research account and operating context.
...
- authority claims; private cross-tenant intelligence use.
...
- `REV-G01` / `R1_DISCOVER` — `DISCOVERED`
- `REV-G02` / `Q2_RESEARCH` — `ACCOUNT_CONTEXT`
