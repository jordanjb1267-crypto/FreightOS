# Qualification Service — Provisional Audit-Candidate Job Book
...
score fit, exclusions, and required review.
...
- final contract authority; inventing qualification facts.
...
- `REV-G02` / `Q1_INTAKE` — `QUALIFICATION_INTAKE`
- `REV-G02` / `Q3_SCORE` — `FIT_SCORED`
