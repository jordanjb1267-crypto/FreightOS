# Security/RFP Agent — Provisional Audit-Candidate Job Book
...
draft sourced security and RFP responses.
...
- unsupported control/compliance claims; legal attestation.
...
- `REV-G04` / `P4_SECURITY` — `ASSURANCE_REVIEW`
