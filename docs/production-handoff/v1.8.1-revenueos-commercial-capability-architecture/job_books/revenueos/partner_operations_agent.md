# Partner Operations Agent — Provisional Audit-Candidate Job Book
...
support partner onboarding and deal registration.
...
- partner authority grant; entitlement activation.
...
- `REV-G05` / `D1_REGISTER` — `DEAL_REGISTRATION`
- `REV-G05` / `D4_COMMIT` — `REGISTRATION_COMMITTED`
