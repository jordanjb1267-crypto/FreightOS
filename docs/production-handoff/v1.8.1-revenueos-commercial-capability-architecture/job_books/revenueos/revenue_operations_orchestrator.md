...
- commercial approval; operational logistics authority.
...
- `REV-G01` / `R6_ROUTE` — `ROUTED`
- `REV-G02` / `Q6_HANDOFF` — `CONFIGURATION_READY`
- `REV-G03` / `S3_DEPENDENCY` — `DEPENDENCIES_RESOLVED`
- `REV-G05` / `D5_ROUTE` — `OPPORTUNITY_ROUTED`
- `REV-G06` / `I5_TRANSFER` — `TRANSFERRED`
- `REV-G07` / `E5_REENTER` — `REENTER_SOLUTION_GRAPH`
