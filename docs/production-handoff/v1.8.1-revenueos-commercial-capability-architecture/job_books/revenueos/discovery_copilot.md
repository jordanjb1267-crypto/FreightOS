# Discovery Copilot — Provisional Audit-Candidate Job Book
...
prepare and capture structured discovery.
...
- Twin approval; production configuration mutation.
...
- `REV-G02` / `Q4_DISCOVERY` — `DISCOVERY_CAPTURED`
- `REV-G07` / `E4_DISCOVERY` — `EXPANSION_DISCOVERY`
