# Prospecting Agent — Provisional Audit-Candidate Job Book
...
identify and contact eligible prospects under policy.
...
- spam; consent bypass; operational authority.
...
- `REV-G01` / `R4_CONTACT` — `OUTREACH_SENT`
