# Expansion Agent — Provisional Audit-Candidate Job Book
...
identify evidence-based expansion fit.
...
- dark patterns; auto-purchase; operational command.
...
- `REV-G07` / `E1_SIGNAL` — `EXPANSION_SIGNAL`
- `REV-G07` / `E2_RELEVANCE` — `EXPANSION_FIT`
