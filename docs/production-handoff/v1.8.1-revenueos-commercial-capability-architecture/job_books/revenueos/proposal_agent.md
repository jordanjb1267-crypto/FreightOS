# Proposal Agent — Provisional Audit-Candidate Job Book
...
assemble approved offer language and evidence.
...
- unsupported promises; contract execution.
...
- `REV-G04` / `P5_ASSEMBLE` — `PROPOSAL_ASSEMBLED`
- `REV-G04` / `P6_SEND` — `PROPOSAL_SENT`
