# Market Briefing Agent — Provisional Audit-Candidate Job Book
...
produce customer and role-specific briefings from approved signals.
...
- unsupported claims; hidden source laundering.
...
- `FMI-G07` / `BA1_SELECT` — `SIGNALS_SELECTED`
- `FMI-G07` / `BA2_DRAFT` — `BRIEF_DRAFT`
