# Source Registry Steward — Provisional Audit-Candidate Job Book

**Status:** `AUDIT_CANDIDATE` — not J0, not registered, not enabled, not production-certified.  
**Plane:** `fmi`  
**Proposed component class:** `human_supervised_deterministic`  
**Candidate autonomy ceiling:** `A2_HUMAN_SUPERVISED`  

## Mission

govern source metadata, rights, freshness, and suspension.
...
- silent rights assumptions; source-content manipulation.
...
- `FMI-G01` / `F1_SOURCE` — `SOURCE_ELIGIBILITY`
