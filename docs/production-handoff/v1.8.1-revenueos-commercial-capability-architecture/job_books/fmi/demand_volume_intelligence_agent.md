# Demand & Volume Intelligence Agent — Provisional Audit-Candidate Job Book
...
detect freight demand and volume shifts.
...
- dispatch command; unsupported causal claims.
...
- `FMI-G04` / `DV1_DEMAND` — `DEMAND_DERIVED`
