# Disruption Intelligence Agent — Provisional Audit-Candidate Job Book
...
detect weather, infrastructure, border, port, and rail disruptions.
...
- emergency authority; route command.
...
- `FMI-G04` / `DV4_DISRUPT` — `DISRUPTION_CONTEXT`
