# Maintenance Market Intelligence Agent — Provisional Audit-Candidate Job Book
...
produce parts, service, OEM, and provider-market intelligence.
...
- repair authorization; spend authority.
...
- `FMI-G08` / `MM1_SOURCE` — `SERVICE_MARKET_INPUT`
- `FMI-G08` / `MM2_REGION` — `REGIONAL_CONTEXT`
- `FMI-G08` / `MM3_AVAIL` — `AVAILABILITY_SIGNAL`
