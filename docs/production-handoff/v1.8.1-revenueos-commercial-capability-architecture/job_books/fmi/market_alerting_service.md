# Market Alerting Service — Provisional Audit-Candidate Job Book
...
route material alerts under explicit policy.
...
- operational action by alert alone; alert-spam escalation.
...
- `FMI-G07` / `BA5_DELIVER` — `DELIVERED`
- `FMI-G07` / `BA6_ACK` — `DELIVERY_RECONCILED`
- `FMI-G10` / `CX5_NOTIFY` — `CORRECTION_NOTICE`
