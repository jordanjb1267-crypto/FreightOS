# Commodity & Seasonality Intelligence Agent — Provisional Audit-Candidate Job Book
...
identify commodity and seasonal freight impacts.
...
- commodity trading; unsupported causal certainty.
...
- `FMI-G04` / `DV2_SEASON` — `SEASONAL_CONTEXT`
