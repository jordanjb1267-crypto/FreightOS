# Fuel & Energy Intelligence Service — Provisional Audit-Candidate Job Book

**Status:** `AUDIT_CANDIDATE` — not J0, not registered, not enabled, not production-certified.  
**Plane:** `fmi`  
**Proposed component class:** `deterministic_hybrid`  
**Candidate autonomy ceiling:** `A1_DETERMINISTIC_ROUTING_OR_CALCULATION`  

## Mission

publish fuel and energy observations and bounded trends.
...
- customer fuel policy mutation; purchasing authority.
