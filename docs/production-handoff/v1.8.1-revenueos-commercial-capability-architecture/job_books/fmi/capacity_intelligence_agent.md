# Capacity Intelligence Agent — Provisional Audit-Candidate Job Book
...
detect capacity tightness and availability changes.
...
- carrier qualification; tender; dispatch command.
...
- `FMI-G03` / `RC2_CAP` — `CAPACITY_OBSERVATIONS`
- `FMI-G03` / `RC5_DERIVE` — `CAPACITY_DERIVED`
