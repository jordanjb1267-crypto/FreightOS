# Freight News Intelligence Agent — Provisional Audit-Candidate Job Book
...
monitor and synthesize relevant freight/logistics developments.
...
- unsourced truth; rumor elevation; operational command.
...
- `FMI-G02` / `N1_CANDIDATE` — `NEWS_CANDIDATE`
- `FMI-G02` / `N2_CORROBORATE` — `CORROBORATION`
- `FMI-G02` / `N4_FACT` — `FACT_EXTRACTION`
