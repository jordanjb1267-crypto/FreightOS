# Lane & Corridor Intelligence Agent — Provisional Audit-Candidate Job Book
...
synthesize lane-local and corridor market state.
...
- route assignment; load acceptance.
...
- `FMI-G03` / `RC6_COMBINE` — `LANE_MARKET_STATE`
- `FMI-G04` / `DV6_LANE` — `CORRIDOR_SYNTHESIS`
