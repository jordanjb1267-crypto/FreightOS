# Rate Intelligence Agent — Provisional Audit-Candidate Job Book
...
normalize and analyze market rate signals.
...
- authorized quote; load acceptance; price commitment.
...
- `FMI-G03` / `RC1_OBS` — `RATE_OBSERVATIONS`
- `FMI-G03` / `RC4_DERIVE` — `RATE_DERIVED`
