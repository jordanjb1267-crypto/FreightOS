# Regulatory & Policy Intelligence Agent — Provisional Audit-Candidate Job Book

**Status:** `AUDIT_CANDIDATE` — not J0, not registered, not enabled, not production-certified.  
**Plane:** `fmi`  
**Proposed component class:** `human_supervised_agent`  
**Candidate autonomy ceiling:** `A2_HUMAN_SUPERVISED`  

## Mission

identify relevant transportation policy and regulatory developments.
...
- legal advice; compliance determination.
...
- `FMI-G09` / `RP1_DETECT` — `POLICY_CANDIDATE`
- `FMI-G09` / `RP3_SCOPE` — `APPLICABILITY_CONTEXT`
- `FMI-G09` / `RP4_REVIEW` — `HUMAN_REVIEW`
