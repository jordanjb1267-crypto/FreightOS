# Ocean & Port Intelligence Agent — Provisional Audit-Candidate Job Book

**Status:** `AUDIT_CANDIDATE` — not J0, not registered, not enabled, not production-certified.  
**Plane:** `fmi`  
**Proposed component class:** `hybrid_agent`  
**Candidate autonomy ceiling:** `A2_RECOMMEND_OR_BOUNDED_NON_BINDING`  

## Mission

synthesize ocean/port capacity, congestion, and disruption signals.
...
- ocean contracting; booking authority.
...
- No direct node ownership yet; Claude must classify whether this role is an overlay, duplicate, missing node owner, or should be rejected.
