# Market Regime Classification Service — Provisional Audit-Candidate Job Book

**Status:** `AUDIT_CANDIDATE` — not J0, not registered, not enabled, not production-certified.  
**Plane:** `fmi`  
**Proposed component class:** `deterministic_model_service`  
**Candidate autonomy ceiling:** `A1_DETERMINISTIC_ROUTING_OR_CALCULATION`  

## Mission

classify bounded market regimes from approved metrics.
...
- business policy changes; command authority.
...
- `FMI-G04` / `DV5_REGIME` — `REGIME_CLASSIFIED`
